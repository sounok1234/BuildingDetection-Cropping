...
class YOLO(object):
    ...
    def detect_img(self, image):
        ...
        r_image, crop = self.detect_image(original_image_color)
        return r_image, crop
...
if __name__=="__main__":
    ...
    while i < 952:
        image = 'Gen (' + str(i) + ').jpg'
        r_image, crop = yolo.detect_img(image)
        if type(crop) is int:
            #os.rename(r'C:/Users/sounok.sarkar/Desktop/YOLOv3-custom-training/Nest' + str(i) + '.jpg', r'C:/Users/sounok.sarkar/Desktop/YOLOv3-custom-training/a_Nest' + str(i) + '.jpg')
            cv2.imwrite("a_Final" + str(i) + ".jpg", r_image)
        else:
            try:
                cv2.imwrite("Final" + str(i) + ".jpg", crop)
            except:
                cv2.imwrite("a_Final" + str(i) + ".jpg", r_image)
                #os.rename(r'C:/Users/sounok.sarkar/Desktop/YOLOv3-custom-training/Nest' + str(i) + '.jpg', r'C:/Users/sounok.sarkar/Desktop/YOLOv3-custom-training/a_Nest' + str(i) + '.jpg')
                #print(crop)
